...
2. Add a `SKILL.md` file following the [Agent Skills format](docs/agent-skills.md)
...
- **App bugs** — Report at [skales.app/feedback](https://skales.app/feedback) or use the in-app Bug Report button
